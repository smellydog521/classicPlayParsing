# statistics on convergence_weighted_3_node.txt
...
def main(argv):
    ...
    f = open('./convergence_weighted_3_node.txt','r')
    fi = open('./convergence_weighted_3_node.csv','w+')
